  ...
  return (
    <header className="sticky top-0 z-50 w-full shadow-lg px-6 py-6 max-w-full ">
      <nav className="container mx-auto flex h-14 items-center justify-between px-4">
        ...
        <div className={`fixed right-0 top-0 h-full w-64 transform bg-[#020B2D] z-20 p-6 transition-transform duration-300 ease-in-out ${isOpen ? "translate-x-0" : "translate-x-full"} lg:hidden shadow-lg`}>          
          {/* Close Button */}
