...
const TeamPage2 = () => {
    ...
    return (
        <div className="team-page">
            <h1 className=" text-4xl text-center md:text-6xl mb-5 lg:mb-12 lg:text-6xl font-press text-[#B01D15] drop-shadow-[0_0_20px_#B01D15] ">The Official Team of Ureckon'25</h1>
