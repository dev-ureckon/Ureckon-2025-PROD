...
function Statistics() {
  ...
  return (
    <section className="m-4">
      ...
      {/* row one */}
      <div className="row-one flex flex-col flex-wrap justify-center items-center gap-4 m-4 p-4 lg:flex-row">
            ...
            <CardBody className="bg-transparent relative group/card w-full rounded-xl flex justify-center items-center m-0 p-0">
              <CardItem translateZ="50" className="text-xl lg:text-xl font-bold text-neutral-600 dark:text-white">
                <div className="bg-[rgba(320,0,10,0.15)] rounded-xl flex flex-col justify-evenly items-center w-full min-h-[150px] sm:h-[180px] lg:h-[150px] lg:min-w-[325px] md:min-w-[300px] p-4">
                  <p className="text-center font-press text-xl md:text-2xl lg:text-xl font-semibold text-red-700 statistics-text-shadow">
                    {stat.title}
                  </p>
                  <p className="text-center font-press text-xl md:text-2xl lg:text-xl font-semibold text-red-700 statistics-text-shadow">
      ...
      {/* row two */}
      <div className="row-two flex flex-wrap justify-center items-center gap-4 m-4 p-4 w-full md:m-0 md:p-0 sm:m-0 sm:p-0">
        {rowTwo.map((stat, index) => (
          <div
            key={index}
            className="w-[200px] sm:w-[250px] md:w-[300px]  lg:w-full lg:max-w-[70%] min-w-[200px] relative right-4 md:right-0"
          >
      ...
      {/* row three */}
      <div className="row-three flex flex-col flex-wrap justify-center items-center gap-4 m-4 p-4 lg:flex-row">
