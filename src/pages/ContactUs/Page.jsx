          ...
          <div className="opacity-60 max-w-full mx-auto flex flex-col-reverse lg:flex-row justify-between gap-6 lg:gap-8 mt-10">
            <div className="flex flex-col items-center p-0 lg:p-3 w-full lg:w-[60%]">
              ...
              <div className="w-full flex items-center justify-center">
                <PinContainer title="uem kolkata" href="https://maps.app.goo.gl/KFRT3UGtFcYqjbyL7">
            ...
            <div className="p-4 w-full lg:w-[60%]">
              <form ref={form} onSubmit={sendEmail} className="space-y-4 relative z-10">
                <div>
                  <label htmlFor="name" className="block text-xs md:text-sm font-press leading-[27px] underline text-[#FDFDFD]">
                    NAME
                  </label>
                  <input
                    type="text"
                ...
                <div>
                  <label htmlFor="email" className="block text-xs md:text-sm font-press leading-[27px] underline text-[#FDFDFD]">
                    EMAIL
                  </label>
                  <input
                    type="email"
                ...
                <div>
                  <label htmlFor="phone" className="block text-xs md:text-sm font-press leading-[27px] underline text-[#FDFDFD]">
                    PHONE
                  </label>
                  <input
                    type="text"
                ...
                <div>
                  <label htmlFor="message" className="block text-xs md:text-sm font-press leading-[27px] underline text-[#FDFDFD] mb-2">
                    MESSAGE
                  </label>
                  <textarea
                    name="message"
                ...
                <div className="flex justify-center">
                  <button type="submit" className="p-2 bg-orange-500 hover:bg-orange-600 text-black text-sm font-bold tracking-widest leading-5 py-2">
                    SUBMIT
                  </button>
                </div>
              </form>
